...
https://metacpan.org/release/List-SomeUtils-XS

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends List::SomeUtils::XS
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends List::SomeUtils::XS
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/List-SomeUtils-XS).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=List-SomeUtils-XS)
or [via email](bug-list-someutils-xs@rt.cpan.org.
...
template file originating in Dist-Zilla-PluginBundle-DROLSKY-0.51.
